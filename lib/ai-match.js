...
Найди в интернете (используй веб-поиск) известные неоригинальные/кросс-номера — взаимозаменяемые
аналоги от известных производителей автозапчастей (напр. Febi, Blue Print, VAICO, TYC, Depo и т.п.)
для этого OEM-номера.
